...
type
  ...
  public
    ...
    procedure DecUsedLength(const aChars: Integer);
  public
...
procedure TOTextBuffer.DecUsedLength(const aChars: Integer);
begin
  if UsedLength-aChars<0 then
    UsedLength := 0
  else
    UsedLength := UsedLength-aChars;
end;
