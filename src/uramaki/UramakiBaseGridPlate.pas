...
resourcestring
  ...
  SCopyValueToClipboardMenuCaption = 'Copy value to clipboard';
  SCopyValueToClipboardMenuHint = 'Copy the value of the current cell to clipboard';
...
type
  ...
  protected
    ...
    procedure DoCopyValueOfCurrentCellToClipboard(Sender : TObject); virtual; abstract;
...
begin
  ...
  mItm := TMenuItem.Create(FGridCommandsPopupMenu);
  FGridCommandsPopupMenu.Items.Add(mItm);
  mItm.OnClick:= Self.DoCopyValueOfCurrentCellToClipboard;
  mItm.Hint:= SCopyValueToClipboardMenuHint;
  mItm.Caption:= SCopyValueToClipboardMenuCaption;
